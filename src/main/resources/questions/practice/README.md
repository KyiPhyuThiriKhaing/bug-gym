# Java Beginner Practice Questions Index

This repository contains a collection of beginner-friendly Java practice questions designed to build a strong foundation in programming logic, loops, arrays, and string manipulation.

---

## 1. Basics, Variables & Arithmetic
*Fundamental input/output, math operations, and variable manipulation.*

- [Question 1](01-basics/Question1.md): **Greeting** (Input a name, print "Hello, Name!")
- [Question 2](01-basics/Question2.md): **Add Two Numbers** (Basic integer addition)
- [Question 3](01-basics/Question3.md): **Area of Rectangle** (Multiplication)
- [Question 4](01-basics/Question4.md): **Square of a Number** (Math operation)
- [Question 5](01-basics/Question5.md): **Quotient and Remainder** (Division and Modulo)
- [Question 6](01-basics/Question6.md): **Swap Variables** (Variable reassignment)
- [Question 7](01-basics/Question7.md): **Minutes to Hours** (Time conversion)
- [Question 8](01-basics/Question8.md): **Celsius to Fahrenheit** (Temperature conversion)

## 2. Logic & Conditionals
*Decision making using if-else and switch statements.*

- [Question 1](02-conditionals/Question1.md): **Positive, Negative, or Zero** (Basic checks)
- [Question 2](02-conditionals/Question2.md): **Even or Odd** (Modulo check)
- [Question 3](02-conditionals/Question3.md): **Max of Two Numbers** (Comparison)
- [Question 4](02-conditionals/Question4.md): **Divisible by 3 and 5** (Compound conditions)
- [Question 5](02-conditionals/Question5.md): **Leap Year Check** (Complex logic)
- [Question 6](02-conditionals/Question6.md): **Simple Calculator** (Switch-case)
- [Question 7](02-conditionals/Question7.md): **Alphabet, Digit, or Symbol** (Character classification)
- [Question 8](02-conditionals/Question8.md): **Absolute Value** (Sign check)
- [Question 9](02-conditionals/Question9.md): **Vowel or Consonant** (Character check)

## 3. Loops & Number Logic
* Iteration, digit manipulation, and logical sequences.*

- [Question 1](03-loops/Question1.md): **Sum of 1 to N** (Accumulator loop)
- [Question 2](03-loops/Question2.md): **Factorial** (Product loop)
- [Question 3](03-loops/Question3.md): **Sum of Even Numbers** (Loop with step/condition)
- [Question 4](03-loops/Question4.md): **Calculate Power** (Multiplication loop)
- [Question 5](03-loops/Question5.md): **Sum of Digits** (Modulo & Division)
- [Question 6](03-loops/Question6.md): **Prime Number Check** (Divisibility loop)
- [Question 7](03-loops/Question7.md): **Fibonacci Sequence** (Sequence generation)
- [Question 8](03-loops/Question8.md): **Count Digits** (While loop)
- [Question 9](03-loops/Question9.md): **Reverse Number** (Math logic)
- [Question 10](03-loops/Question10.md): **Product of Digits** (Digit extraction)
- [Question 11](03-loops/Question11.md): **Sum of First N Odd Numbers** (Odd sequence)
- [Question 12](03-loops/Question12.md): **Multiples of N** (Loop output)

## 4. Strings & Characters
*Text processing, ASCII, and string methods.*

- [Question 1](04-strings/Question1.md): **Reverse String** (String traversal)
- [Question 2](04-strings/Question2.md): **Palindrome Check** (String comparison)
- [Question 3](04-strings/Question3.md): **Count Vowels** (Character checking)
- [Question 4](04-strings/Question4.md): **Repeat String** (String building)
- [Question 5](04-strings/Question5.md): **Remove Spaces** (Filtering)
- [Question 6](04-strings/Question6.md): **Count Uppercase** (Character class)
- [Question 7](04-strings/Question7.md): **Count Character Frequency** (Iteration)
- [Question 8](04-strings/Question8.md): **Replace Vowels** (String modification)
- [Question 9](04-strings/Question9.md): **Print ASCII Value** (Casting)
- [Question 10](04-strings/Question10.md): **Toggle Case** (Upper <-> Lower)
- [Question 11](04-strings/Question11.md): **Swap First & Last Char** (Substring/Char logic)
- [Question 12](04-strings/Question12.md): **Compare Strings** (Case Insensitive)
- [Question 13](04-strings/Question13.md): **Count Words** (Whitespace split)

## 5. 1D Arrays
*Collections of data, searching, and sorting logic.*

- [Question 1](05-arrays-1d/Question1.md): **Max Element** (Find largest)
- [Question 2](05-arrays-1d/Question2.md): **Average of Numbers** (Sum & Division)
- [Question 3](05-arrays-1d/Question3.md): **Linear Search** (Find index)
- [Question 4](05-arrays-1d/Question4.md): **Count Occurrences** (Frequency in array)
- [Question 5](05-arrays-1d/Question5.md): **Min Element** (Find smallest)
- [Question 6](05-arrays-1d/Question6.md): **Reverse Array** (In-place or new array)
- [Question 7](05-arrays-1d/Question7.md): **Swap First & Last** (Indexing)
- [Question 8](05-arrays-1d/Question8.md): **Check Sorted** (Comparison)
- [Question 9](05-arrays-1d/Question9.md): **Sum of Two Arrays** (Parallel processing)
- [Question 10](05-arrays-1d/Question10.md): **Last Index Search** (Backwards traversal)
- [Question 11](05-arrays-1d/Question11.md): **Sum of Array** (Accumulator)
- [Question 12](05-arrays-1d/Question12.md): **Check Duplicates** (Nested loops)
- [Question 13](05-arrays-1d/Question13.md): **Count Even/Odd** (Filtering)
- [Question 14](05-arrays-1d/Question14.md): **Move Zeros to End** (Rearrangement)
- [Question 15](05-arrays-1d/Question15.md): **Second Largest** (Distinct max)
- [Question 16](05-arrays-1d/Question16.md): **Insert at Position** (Array shift)

## 6. 2D Arrays & Matrices
*Grid-based logic and nested loops.*

- [Question 1](06-arrays-2d/Question1.md): **Total Sum of Matrix** (Nested iteration)
- [Question 2](06-arrays-2d/Question2.md): **Add Two Matrices** (Matrix Arithmetic)
- [Question 3](06-arrays-2d/Question3.md): **Sum of Each Row** (Row traversal)
- [Question 4](06-arrays-2d/Question4.md): **Sum of Main Diagonal** (Indexing logic)
- [Question 5](06-arrays-2d/Question5.md): **Max in Matrix** (Search)
- [Question 6](06-arrays-2d/Question6.md): **Count Element in Matrix** (Frequency)
